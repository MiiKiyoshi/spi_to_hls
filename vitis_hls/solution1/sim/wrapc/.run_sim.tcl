...
# 
# ==============================================================
set ::env(PATH) "$::env(PATH);G:/TOOLS/Xilinx/Vitis_HLS/2023.2/win64/tools/fpo_v7_1"
set ::env(PATH) "$::env(PATH);G:/TOOLS/Xilinx/Vitis_HLS/2023.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);G:/TOOLS/Xilinx/Vitis_HLS/2023.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);G:/TOOLS/Xilinx/Vitis_HLS/2023.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "divide_sum.autotvin.dat"
	set constFileTvOut       "divide_sum.autotvout.dat"
	set constFileHdlTvIn     "divide_sum.autohdltvin.dat"
	set constFileHdlTvOut    "divide_sum.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
