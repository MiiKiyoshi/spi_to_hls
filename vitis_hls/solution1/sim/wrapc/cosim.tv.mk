...
$(ObjDir)/tb_divide_sum.cpp_pre.cpp.tb.o : tb_divide_sum.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_divide_sum.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/divide_sum.cpp_pre.cpp.tb.o : divide_sum.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling divide_sum.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
