...
if {[file isfile divide_sum.autotvin.dat]} {
	file delete -force divide_sum.autotvin.dat
}

if {[file isfile divide_sum.autotvout.dat]} {
	file delete -force divide_sum.autotvout.dat
}
