...
signed int dot_product(signed int *, signed int *, signed int *);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = call i32 @dot_product(i32* %%11, i32* %%12, i32* %%13) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_33_count);
  dot_product((signed int *)llvm_cbe_tmp__9, (signed int *)llvm_cbe_tmp__10, (signed int *)llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE) {
