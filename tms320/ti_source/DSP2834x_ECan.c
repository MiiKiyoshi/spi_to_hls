...
#include <ti_include/DSP2834x_Device.h>     // DSP28 Headerfile Include File
#include <ti_include/DSP2834x_Examples.h>   // DSP28 Examples Include File
...
/* Configure bit timing parameters for eCANA*/
    ...
    #if (CPU_FRQ_300MHZ)                       // CPU_FRQ_300MHz is defined in DSP2834x_Examples.h
	/* The following block for all 300 MHz SYSCLKOUT (75 MHz CAN clock) - default. Bit rate = 1 Mbps
	   See Note at end of file. */
		ECanaShadow.CANBTC.bit.BRPREG = 4;
		ECanaShadow.CANBTC.bit.TSEG2REG = 2;
		ECanaShadow.CANBTC.bit.TSEG1REG = 10;
    #endif
	#if (CPU_FRQ_200MHZ)                       // CPU_FRQ_200MHz is defined in DSP2834x_Examples.h
	/* The following block is only for 200 MHz SYSCLKOUT (50 MHz CAN clock). Bit rate = 1 Mbps
	   See Note at end of file. */
	    ECanaShadow.CANBTC.bit.BRPREG = 4;
...
/* Enable internal pull-up for the selected CAN input pins.
   Disable internal pull-up to reduce power consumption for the
   selected CAN output pins */
...
//	GpioCtrlRegs.GPAPUD.bit.GPIO19 = 1;	    // Disable pull-up for GPIO19 (CANTXA)
...
/* Note: Bit timing parameters must be chosen based on the network parameters such as
   ...
   The parameters used in this file may need to be changed taking into account
   the above mentioned factors in order to arrive at the bit-timing parameters
