...
HD_PWD='C:/works/verilog/starlite_prj/spi_divide_sum_baremetal/vivado_bd/vivado_bd.runs/design_1_spi_to_hls_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_spi_to_hls_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_spi_to_hls_0_0.tcl
